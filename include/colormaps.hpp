...
inline glm::vec3 magma(float t)
{
    const glm::vec3 c0 = glm::vec3(-0.002136485053939582, -0.000749655052795221, -0.005386127855323933);
    const glm::vec3 c1 = glm::vec3(0.2516605407371642, 0.6775232436837668, 2.494026599312351);
    const glm::vec3 c2 = glm::vec3(8.353717279216625, -3.577719514958484, 0.3144679030132573);
    const glm::vec3 c3 = glm::vec3(-27.66873308576866, 14.26473078096533, -13.64921318813922);
    const glm::vec3 c4 = glm::vec3(52.17613981234068, -27.94360607168351, 12.94416944238394);
    const glm::vec3 c5 = glm::vec3(-50.76852536473588, 29.04658282127291, 4.23415299384598);
    const glm::vec3 c6 = glm::vec3(18.65570506591883, -11.48977351997711, -5.601961508734096);
...
{
    const glm::vec3 c0 = glm::vec3(0.0002189403691192265, 0.001651004631001012, -0.01948089843709184);
    const glm::vec3 c1 = glm::vec3(0.1065134194856116, 0.5639564367884091, 3.932712388889277);
    const glm::vec3 c2 = glm::vec3(11.60249308247187, -3.972853965665698, -15.9423941062914);
    const glm::vec3 c3 = glm::vec3(-41.70399613139459, 17.43639888205313, 44.35414519872813);
    const glm::vec3 c4 = glm::vec3(77.162935699427, -33.40235894210092, -81.80730925738993);
    const glm::vec3 c5 = glm::vec3(-71.31942824499214, 32.62606426397723, 73.20951985803202);
    const glm::vec3 c6 = glm::vec3(25.13112622477341, -12.24266895238567, -23.07032500287172);
